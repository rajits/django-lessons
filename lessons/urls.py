...
urlpatterns = patterns('lessons.views',
    ...
    url(r'^lesson/(?P<slug>[-\w]*)/other_notes/$', 'lesson_detail', {'template_name': 'lessons/fragments/other_notes.html'}),
    url(r'^lesson/(?P<slug>[-\w]*)/background-information/$', 'lesson_detail', {'template_name': 'lessons/fragments/bg_information.html'}),
)
